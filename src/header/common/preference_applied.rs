use std::fmt;
use crate::header::{Header, HeaderFormat, Preference};
use crate::header::parsing::{from_comma_delimited, fmt_comma_delimited};
...
/// # Examples
/// ```
/// use mco_http::header::{Headers, PreferenceApplied, Preference};
///
...
__mco_http__deref!(PreferenceApplied => Vec<Preference>);
