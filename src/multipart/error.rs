...
pub enum Error {
    /// The cogo-http request did not have a Content-Type header.
    NoRequestContentType,
    /// The cogo-http request Content-Type top-level Mime was not `Multipart`.
    NotMultipart,
...
impl StdError for Error {
    fn description(&self) -> &str{
        match *self {
            Error::NoRequestContentType => "The cogo-http request did not have a Content-Type header.",
            Error::NotMultipart =>
                "The cogo-http request Content-Type top-level Mime was not multipart.",
            Error::BoundaryNotSpecified =>
            ...
            Error::Hyper(_) => "A cogo-http error occurred.",
